...
function UpdateVehicles({ trigger, setTrigger, updateVehiclesItem, vehicle }) {
  const [licensePlateNum, setLicensePlateNum] = useState(vehicle.licensePlateNum);
  ...
  const [manufacturingYear, setManufacturingYear] = useState(vehicle.manufacturingYear);
  const [vehicleOwnership, setVehicleOwnership] = useState(vehicle.vehicleOwnership);
  ...
  // Modify the return statement to use the new state variables and event handlers.
