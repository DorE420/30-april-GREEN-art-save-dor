...
export const LoginForm = (props) => {
  ...
  const loginHandler = (e) => {
    ...
    fetch(urllogin,{
      ...
      headers: {
        ...
        'Accept':'application/json; charset=UTF-8' // Add the 'Content-Type' header
      },
  ...
  const resetPasswordHandler = () => {
    ...
    const urlChngPW ="https://proj.ruppin.ac.il/cgroup96/prod/api/employee/resetpw";
  ...
  return (
    <div id="mainPageLoginForm">
      ...
      <div className="innerLogInCover">
       <img
        src="https://proj.ruppin.ac.il/cgroup96/prod/build/images/logo.jpg"
        alt="Green Art Logo"
        width="180"
        height="120"
       />
